...
class Config {
  ...
  Config() {
    _pomodoroMinutes = {
      PomodoroMode.concentration: (SharedPreferencesData.concentrationMinutes ?? defaultConcentrationMinutes)  * 60,
      PomodoroMode.shortBreak: (SharedPreferencesData.breakMinutes ?? defaultBreakMinutes ) * 60,
      PomodoroMode.longBreak: (SharedPreferencesData.longerBreakMinutes ?? defaultLongerBreakMinutes ) * 60,
    };
    _countUntilLongerBreak = (SharedPreferencesData.countUntilLongerBreak ?? defaultCountUntilLongerBreak );
  }
