...
class LearningAidBodyDetailsScreen extends StatelessWidget {
  ...
  const LearningAidBodyDetailsScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocProvider<AlterLearnListCubit>(
      ...
      child: const LearningAidBodyDetailsScreenMainElement(),
    );
  }
}

class LearningAidBodyDetailsScreenMainElement extends StatefulWidget {
  const LearningAidBodyDetailsScreenMainElement({Key? key}) : super(key: key);

  @override
  State<LearningAidBodyDetailsScreenMainElement> createState() =>
      _LearningAidBodyDetailsScreenMainElementState();
}

class _LearningAidBodyDetailsScreenMainElementState extends State<LearningAidBodyDetailsScreenMainElement> {
