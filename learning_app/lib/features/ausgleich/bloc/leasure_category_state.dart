...
class LeasureCategoryState extends Equatable {
  ...
  LeasureCategoryState() {
    leasureCategories = [
      ...
      const LeasureCategory(
          "Fitness ohne Geräte", "assets/leasure/leasure-group-fitness.png", 7, 17),
      const LeasureCategory(
          "Yoga & Meditation", "assets/leasure/leasure-group-yoga.png", 4, 11),
      const LeasureCategory(
          "Outdoor & Bewegung", "assets/leasure/leasure-group-outdoor.png", 0, 5), 
      const LeasureCategory(
          "Weitere Vorschäge", "assets/leasure/leasure-group-further.png", 1, 7), 
    ];
  }
