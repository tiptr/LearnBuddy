...
import '../features/categories/persistence/categories_dao.dart' as _i21;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i19.TimeLogsDao>(_i19.TimeLogsDao(get<_i5.Database>()));
  gh.singleton<_i20.BodyListWordDetailsDao>(
      _i20.BodyListWordDetailsDao(get<_i5.Database>()));
  gh.singleton<_i21.CategoriesDao>(_i21.CategoriesDao(get<_i5.Database>()));
  return get;
}
