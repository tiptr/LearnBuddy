      ...
      batch.insertAll(
        ...
        [
          ...
          LeisureActivitiesCompanion.insert(
            ...
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-fun-crazy-cats.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(2),
            leisureCategoryId: 0,
            ...
            isFavorite: false,
            pathToImage:
                const Value<String>('assets/leisure/leisure-fun-confusion.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(3),
            leisureCategoryId: 0,
          ...
          LeisureActivitiesCompanion.insert(
            ...
            descriptionLong: const Value<String>(
                'Alles ist erlaubt. Du darfst den Luftballon mit deinen Füßen, Armen, ja deinem ganzen Körper in der Luft halten. Aber pass auf, dass er nicht den Boden berührt! Wie lange kannst du es schaffen?'),
            isFavorite: false,
            pathToImage:
                const Value<String>('assets/leisure/leisure-fun-balloon.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(5),
            leisureCategoryId: 0,
            ...
            descriptionLong: const Value<String>(
                'Nehme kein Glas! Es sollte ein Plastikbecher sein. Lasse nun deine Hände auf deinem Rücken. Schaffst du es den Becher auszutrinken ohne deine Hände zur Hilfe zu nehmen?'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-fun-drink-without-hands.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(6),
            leisureCategoryId: 0,
            ...
            descriptionLong: const Value<String>(
                'Du kannst deinen Kater, deine Freunde, dein Zimmer, oder ähnliches Zeichnen. Sei kreativ! Überlege dir genau wie es aussehen soll und schließe dann deine Augen. Versuche dein Motiv so gut wie möglich zu zeichnen, ohne deine Augen zu öffnen!'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-fun-paint-blindly.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(7),
            leisureCategoryId: 0,
            ...
            descriptionLong: const Value<String>(
                'Ein Kartenhaus baust du, indem du zwei Karten zu einem Dreieck zusammenstellst. Die Karten berühren sich also an den Spitzen, aber ihre Enden sind von einander entfernt. Nun baust du mehrere Dreiecke nebeneinander. Danach kannst du über je zwei Dreiecke eine neue Karte legen. Nun hast du schon eine Etage geschafft! Kannst du noch höher bauen?'),
            isFavorite: false,
            pathToImage:
                const Value<String>('assets/leisure/leisure-fun-home.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(8),
            leisureCategoryId: 0,
            ...
            isFavorite: false,
            pathToImage:
                const Value<String>('assets/leisure/leisure-fun-lemon.svg'),
          ),
          /**************************************************************************************************/
          //Fitness ohne Geräte
          LeisureActivitiesCompanion.insert(
            ...
            name: 'Dips am Stuhl',
            duration: const Duration(minutes: 5),
            descriptionShort: '10 Dips, dann eine Kurze Pause',
            descriptionLong: const Value<String>(
                'Stelle deine Beine Hüftbreit auf. Drehe dem Stühl deine Rücken zu. Fasse nun mit deinen Händen an die Seiten der Sitzfläche. Versuche deinen Oberkörper gerade zu halten und senke dein Gesäß bis kurz über den Boden ab. Drücke dich danach wieder hoch.'),
            isFavorite: false,
            pathToImage:
                const Value<String>('assets/leisure/leisure-fitness-dips.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(10),
            leisureCategoryId: 1,
          ...
          LeisureActivitiesCompanion.insert(
            ...
            duration: const Duration(minutes: 5),
            descriptionShort: 'Jogge im stehen',
            descriptionLong: const Value<String>(
                'Halte deine Arme leicht gewinkelt an deinem Körper und bewege sie rhytmisch mit. Wenn dein linkes Knie nach oben geht, so geht dein rechter Ellenbogen nach vorne und umgekehrt. Versuche nicht zu trampeln, sondern gut zu federn mit deinen Knien.'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-fitness-standing-run.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(13),
            leisureCategoryId: 1,
            name: 'Planks mit gestreckten Knien',
            duration: const Duration(minutes: 5),
            descriptionShort: 'Halte einen Plank dreimal so lange du kannst',
            descriptionLong: const Value<String>(
                'Setze die Knie auf dem Boden ab, platziere Deine Unterarme auf den Boden (so dass die Ellenbogen unterhalb der Schultergelenke sind) und stemme Dich nach oben. Spanne dabei Deinen Bauch und Po fest an und achte darauf, dass Dein Körper eine gerade Linie bildet. Halte auch in den Schultergelenken Spannung. Vergewissere Dich, dass Du kein Hohlkreuz machst und Dein unterer Rücken nicht durchhängt. Halte diese Position für einige Sekunden und mache dann keine kurze Pause, indem Du die Knie wieder auf dem Boden absetzt oder Dich flach auf den Boden legst.'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-fitness-planke.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(14),
            leisureCategoryId: 1,
            name: 'Burpees',
            duration: const Duration(minutes: 5),
            descriptionShort: 'Mache so viele Burpees wie du schaffst.',
            descriptionLong: const Value<String>(
                'Stelle Dich zunächst hüftbreit und aufrecht auf Deine Füße, bevor Du in die breite Hocke gehst und Deine Hände ebenfalls hüftbreit vor Deine Füße auf dem Boden aufstellst. Springe nun mit beiden Füßen gleichzeitig nach hinten und mache einen Liegestütz. Im Anschluss daran springst Du mit beiden Füßen wieder nach vorn in die Hocke und richtest Dich auf. Achtung: Die Knie sind nun noch leicht gebeugt, die Arme nach hinten gestreckt. Nun schwingen Deine Arme kraftvoll nach vorn und oben, Dein gesamter Körper folgt ihnen in einen kraftvollen Strecksprung nach oben. Nachdem Du nun wieder in der Ausgangsposition gelandet bist, wiederholt sich der ganze Ablauf, wie bereits beschrieben.'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-fitness-planke-burpees.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(15),
            leisureCategoryId: 1,
            ...
            duration: const Duration(minutes: 10),
            descriptionShort: 'Mache so viele Bergsteiger wie du schaffst.',
            descriptionLong: const Value<String>(
                'Nehme zunächst die Liegestütz-Startposition ein. Achte besonders darauf, dass Dein Körper eine gerade Linie bildet und Du von den Fußspitzen bis zum Nacken Deinen gesamten Körper angespannt hast. Kontrolliere noch einmal, ob Deine Hände sich auch wirklich direkt unter Deinen Schultern befinden, bevor Du startest. Ziehe abwechselnd das linke und das rechte Bein an den Oberkörper und versuche mit Deinen Knien die Brustmuskulatur zu berühren. Strecke das Bein nun wieder, stelle den Fuß ab und mache leiche mit der anderen Seite.'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-fitness-mountain-climber.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(16),
            leisureCategoryId: 1,
          ...
          LeisureActivitiesCompanion.insert(
            ...
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-fitness-leg-lift-planke.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(18),
            leisureCategoryId: 1,
          ...
          LeisureActivitiesCompanion.insert(
            ...
            descriptionShort: 'Mache so viele Wiederholungen wie du schaffst.',
            descriptionLong: const Value<String>(
                'Grundstellung ist der Ausfallschritt. Die Arme liegen locker an den Seiten an. Bringe nun Spannung auf den Rumpf, balle Deine Hände zu festen Fäusten. Heb das Knie des hinteren Beins nach vorne an, bis sich der Oberschenkel des gebeugten Beins in einer parallelen Position zum Boden befindet. Gleichzeitig ziehst Du den Arm auf der gleichen Körperseite nach hinten zurück und führst den diagonalen Arm mit Schwung nach vorne oben bis auf Kopfhöhe.'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-fitness-knee-lift.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(24),
            leisureCategoryId: 1,
            ...
            descriptionShort: 'Mache so viele Wiederholungen wie du schaffst.',
            descriptionLong: const Value<String>(
                'Stell Dich schulterbreit auf und stütze die Hände locker knapp oberhalb der Hüfte ab. Spanne die gesamte Rumpf-Muskulatur an. Mach mit dem rechten Bein einen großen Schritt nach vorne und beuge gleichzeitig das linke Knie in Richtung Boden, so dass Du nur noch mit der Spitze des linken Fußes den Boden berührst. Drücke Dich aus dieser Position wieder nach oben in die Ausgangsstellung und wiederhole die Übung mit dem anderen Bein.'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-fitness-big-step.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(25),
            leisureCategoryId: 1,
            ...
            descriptionShort: 'Mache so viele Wiederholungen wie du schaffst.',
            descriptionLong: const Value<String>(
                'Lege Dich bequem mit dem Rücken auf die Matte. Die Arme liegen locker links und rechts parallel zum Körper auf der Matte, die Knie sind angewinkelt, die Füße stehen etwa hüftbreit nebeneinander. Nun spannst Du Bauch-, Rücken- und Po-Muskulatur fest an und hebst Deinen Po vom Boden ab, bis Oberkörper und Oberschenkel eine gerade Linie bilden. Halte diese Position einen Augenblick und senke das Becken dann wieder auf die Matte ab.'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-fitness-standard.svg'),
          ),
          ...
          LeisureActivitiesCompanion.insert(
            ...
            duration: const Duration(minutes: 5),
            descriptionShort: 'Meditiere für eine kurze Zeit.',
            descriptionLong: const Value<String>(
                'Setze dich gemütlich in. Schließe die Augen. Versuche an nichts zu denken. Höre nur deinem Atem zu. Wenn Gedanken kommen, dann nehme sie wahr aber gehe nicht genau auf sie ein und lasse sie weiter ziehen.'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-yoga-meditation.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(27),
            leisureCategoryId: 2,
            ...
            descriptionShort: 'Meditiere etwas länger und entspanne dich.',
            descriptionLong: const Value<String>(
                'Setze dich gemütlich in. Schließe die Augen. Versuche an nichts zu denken. Höre nur deinem Atem zu. Wenn Gedanken kommen, dann nehme sie wahr aber gehe nicht genau auf sie ein und lasse sie weiter ziehen.'),
            isFavorite: false,
            pathToImage: const Value<String>(
          ...
          LeisureActivitiesCompanion.insert(
            ...
            descriptionShort:
                'Bewege dich langsam und bewusst mit deinem Atem. Halte die Übung eine Weile.',
            descriptionLong: const Value<String>(
                'Hebe aus der liegenden Position deine gestreckten Beine an, bis sie ungefähr einen 45° Winkel mit dem Boden bilden. Außerdem hebst du nun Kopf und Schulterblätter an. Der untere Rücken bleibt aber auf dem Boden. Die Arme streckst du in Richtung Knie, die Ellenbogen-Gelenke sind nicht ganz durchgestreckt.'),
            isFavorite: false,
            pathToImage:
                const Value<String>('assets/leisure/leisure-yoga-standard.svg'),
          ),
          ...
          LeisureActivitiesCompanion.insert(
            ...
            name: 'Spaziergang',
            duration: const Duration(minutes: 15),
            descriptionShort: 'Mache einen kurzen Spaziergang.',
            descriptionLong: const Value<String>(
                'Gehe raus an die frische Luft und bewege dich ein bisschen. Achte Bewusst auf deine Umwelt und nimm die kleinen Dinge wahr. Wie der Wind durch deine Haare streift, wie die Wolken heute aussehen und mehr. Atme tief durch!'),
            isFavorite: false,
            pathToImage:
                const Value<String>('assets/leisure/leisure-outdoor-walk.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(38),
            leisureCategoryId: 3,
            ...
            descriptionLong: const Value<String>(
                'Manchmal tut es sehr gut, einfach zu schreien! Gehe dafür an einen abgelegenen Ort, an dem dich keiner hören kann. Nun schreie so laut du kannst und so oft du willst. Denke dabei an alles was dich belastet, aufregt oder runterzieht und lass es gehen! Befreiend oder?'),
            isFavorite: false,
            pathToImage:
                const Value<String>('assets/leisure/leisure-outdoor-walk.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            ...
            descriptionShort: 'Gehe eine lange Runde joggen.',
            descriptionLong: const Value<String>(
                'Jogge für eine Stunde in deiner Geschwindigkeit.'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-outdoor-jogging.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(40),
            leisureCategoryId: 3,
            ...
            descriptionShort: 'Gehe eine kurze Runde joggen.',
            descriptionLong: const Value<String>(
                'Jogge für eine halbe Stunde in deiner Geschwindigkeit.'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-outdoor-jogging.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            ...
            duration: const Duration(minutes: 10),
            descriptionShort: 'Fange einen schönen Moment ein.',
            descriptionLong: const Value<String>(
                'Gehe raus vor die Tür und suche nach dem perfekten Foto. Dies kann ein Blatt sein oder ein Tier. Was auch immer dir positiv auffällt. Schieße ein Foto was dich glücklich macht!'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-outdoor-camera.svg'),
          ),
          /**************************************************************************************************/
          // Weitere Vorschläge
          LeisureActivitiesCompanion.insert(
            ...
            name: 'Malen',
            duration: const Duration(minutes: 15),
            descriptionShort: 'Male ein Motiv deiner Wahl.',
            descriptionLong: const Value<String>(
                'Schnappe dir einen Zeichenblock oder eine Leinwand und sei kreativ!'),
            isFavorite: false,
            pathToImage:
                const Value<String>('assets/leisure/leisure-other-paint.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(43),
            leisureCategoryId: 4,
            name: 'Musik machen',
            duration: const Duration(minutes: 15),
            descriptionShort: 'Übe ein Instrument.',
            descriptionLong: const Value<String>(
                'Du spielst ein Instrument? Prima, dann ist das die perfekte Gelegenheit mal wieder ein bisschen zu üben!'),
            isFavorite: false,
            pathToImage:
                const Value<String>('assets/leisure/leisure-other-music.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(44),
            leisureCategoryId: 4,
            name: 'Singen',
            duration: const Duration(minutes: 15),
            descriptionShort: 'Singe ein paar Songs.',
            descriptionLong: const Value<String>(
                'Suche dir ein paar Lieder deiner Wahl heraus und singe mit!'),
            isFavorite: false,
            pathToImage:
                const Value<String>('assets/leisure/leisure-other-singing.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(45),
            leisureCategoryId: 4,
            ...
            duration: const Duration(minutes: 15),
            descriptionShort: 'Lerne eine neue Sprache deiner Wahl',
            descriptionLong: const Value<String>(
                'Du wolltest schon immer mal diese eine neue Sprache lernen? Prima, dann ist dies jetzt die richtige Gelegenheit dafür!'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-other-new-language.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(46),
            leisureCategoryId: 4,
            ...
            duration: const Duration(minutes: 15),
            descriptionShort: 'Lerne etwas neues!',
            descriptionLong: const Value<String>(
                'Du wolltest schon immer dieses eine Instrument spielen können? Prima! Dann ist jetzt die richtige Gelegenheit dafür!'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-other-new-instrument.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(47),
            leisureCategoryId: 4,
            ...
            duration: const Duration(minutes: 60),
            descriptionShort: 'Probiere neue Rezepte!',
            descriptionLong: const Value<String>(
                'Immer das selbe ist langweilig! Probiere mal etwas neues aus!'),
            isFavorite: false,
            pathToImage: const Value<String>(
                'assets/leisure/leisure-other-cooking-baking.svg'),
          ),
          LeisureActivitiesCompanion.insert(
            id: const Value(48),
            leisureCategoryId: 4,
