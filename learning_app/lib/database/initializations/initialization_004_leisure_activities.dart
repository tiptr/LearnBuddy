  ...
  await _dao.batch((batch) {
    batch.insertAll(_dao.leisureActivities, [
      ...
      LeisureActivitiesCompanion.insert(
        ...
        isFavorite: false,
        pathToImage:
            const Value<String>('assets/leisure/leisure-fun-smiling-cats.svg'),
      ),
      LeisureActivitiesCompanion.insert(
        id: const Value(1),
        leisureCategoryId: 0,
        ...
        isFavorite: false,
        pathToImage:
            const Value<String>('assets/leisure/leisure-fun-crazy-cats.svg'),
      ),
      LeisureActivitiesCompanion.insert(
        id: const Value(2),
        leisureCategoryId: 0,
      ...
      LeisureActivitiesCompanion.insert(
        ...
        isFavorite: false,
        pathToImage:
            const Value<String>('assets/leisure/leisure-fun-roll-tongue.svg'),
      ),
      LeisureActivitiesCompanion.insert(
        id: const Value(4),
        leisureCategoryId: 0,
      ...
      LeisureActivitiesCompanion.insert(
        ...
        isFavorite: false,
        pathToImage:
            const Value<String>('assets/leisure/leisure-fun-paint-blindly.svg'),
      ),
      LeisureActivitiesCompanion.insert(
        id: const Value(7),
        leisureCategoryId: 0,
      ...
      LeisureActivitiesCompanion.insert(
        ...
        isFavorite: false,
        pathToImage:
            const Value<String>('assets/leisure/leisure-fitness-pushups.svg'),
      ),
      LeisureActivitiesCompanion.insert(
        id: const Value(11),
        leisureCategoryId: 1,
      ...
      LeisureActivitiesCompanion.insert(
        ...
        isFavorite: false,
        pathToImage:
            const Value<String>('assets/leisure/leisure-fitness-planke.svg'),
      ),
      LeisureActivitiesCompanion.insert(
        id: const Value(14),
        leisureCategoryId: 1,
      ...
      LeisureActivitiesCompanion.insert(
        ...
        isFavorite: false,
        pathToImage:
            const Value<String>('assets/leisure/leisure-fitness-standard.svg'),
      ),
      LeisureActivitiesCompanion.insert(
        id: const Value(17),
        leisureCategoryId: 1,
      ...
      LeisureActivitiesCompanion.insert(
        ...
        isFavorite: false,
        pathToImage:
            const Value<String>('assets/leisure/leisure-fitness-knee-lift.svg'),
      ),
      LeisureActivitiesCompanion.insert(
        id: const Value(24),
        leisureCategoryId: 1,
        ...
        isFavorite: false,
        pathToImage:
            const Value<String>('assets/leisure/leisure-fitness-big-step.svg'),
      ),
      LeisureActivitiesCompanion.insert(
        id: const Value(25),
        leisureCategoryId: 1,
      ...
      LeisureActivitiesCompanion.insert(
        ...
        isFavorite: false,
        pathToImage:
            const Value<String>('assets/leisure/leisure-yoga-meditation.svg'),
      ),
      LeisureActivitiesCompanion.insert(
        id: const Value(27),
        leisureCategoryId: 2,
      ...
      LeisureActivitiesCompanion.insert(
        ...
        isFavorite: false,
        pathToImage:
            const Value<String>('assets/leisure/leisure-outdoor-jogging.svg'),
      ),
      LeisureActivitiesCompanion.insert(
        id: const Value(40),
        leisureCategoryId: 3,
      ...
      LeisureActivitiesCompanion.insert(
        ...
        isFavorite: false,
        pathToImage:
            const Value<String>('assets/leisure/leisure-outdoor-camera.svg'),
      ),
      /**************************************************************************************************/
      // Weitere Vorschläge
      LeisureActivitiesCompanion.insert(
